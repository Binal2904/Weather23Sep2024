...
public final class Sys {
    ...
    @org.jetbrains.annotations.NotNull
    public final com.demo.advanced.daggerhilt.data.response.weather.Sys copy(int type, int id, double message, @org.jetbrains.annotations.NotNull
    ...
    public Sys(int type, int id, double message, @org.jetbrains.annotations.NotNull
    java.lang.String country, int sunrise, int sunset) {
        super();
    }
