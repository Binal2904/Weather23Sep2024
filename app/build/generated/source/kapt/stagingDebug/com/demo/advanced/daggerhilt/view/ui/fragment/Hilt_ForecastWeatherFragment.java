 ...
 */
public abstract class Hilt_ForecastWeatherFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ForecastWeatherFragment_GeneratedInjector) this.generatedComponent()).injectForecastWeatherFragment(UnsafeCasts.<ForecastWeatherFragment>unsafeCast(this));
    }
  }
